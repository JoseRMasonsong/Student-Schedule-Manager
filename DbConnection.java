...
public class DbConnection extends JFrame {
   ...
   public DbConnection()
   {
      ...
      try {
         ...
         // connect to database
         Connection connection = DriverManager.getConnection("jdbc:sqlite:C:\\sqlite\\DB Browser for SQLite\\Bynum School Schedule.db"); //Replace with your path to your database
